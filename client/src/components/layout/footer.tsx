      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="opacity-80 mb-4 max-w-md">
              رائدة في عالم الأناقة الرجالية، نقدم أفضل الأزياء التقليدية
              والعصرية بجودة عالية وتصاميم فريدة.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-white/10 dark:bg-white/10 light:bg-black/5 hover:bg-primary/20 grid place-items-center transition-all"
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-white/10 dark:bg-white/10 light:bg-black/5 hover:bg-primary/20 grid place-items-center transition-all"
                data-testid="link-social-snapchat"
              >
                📷
              </a>
              <a
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="opacity-60">
            © 2024 مؤسسة الصقر الخليجي. جميع الحقوق محفوظة.
          </p>
        </div>
      </div>
    </footer>
