        ...
        >
          <div className="glass-card p-8 rounded-3xl mb-8">
            <p className="text-lg leading-relaxed mb-6">
              إلى جانب نجاحها في عالم الأزياء، أولت مؤسسة الصقر الخليجي للتجارة والأزياء الفاخرة اهتمامًا خاصًا بـ التنمية المجتمعية، إدراكًا منها بأن دورها لا يقتصر على تقديم الأزياء الراقية فقط، بل يتجاوز ذلك إلى الإسهام في خدمة المجتمع وتعزيز قيم الأناقة والهوية الوطنية.
            </p>
            ...
            <p className="text-lg leading-relaxed">
              هذا التوجه جعل من الصقر الخليجي مؤسسة ذات بصمة مزدوجة: بصمة رائدة في عالم الأزياء الفاخرة، وبصمة مجتمعية حاضرة في تعزيز الهوية الوطنية من خلال الزي التقليدي، تسعى لخلق قيمة مضافة للمجتمع السعودي انسجامًا مع مبادئ رؤية المملكة 2030 في تمكين قطاع الأزياء والموضة من لعب دور تنموي فاعل.
            </p>
          </div>
