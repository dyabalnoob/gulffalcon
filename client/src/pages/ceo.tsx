        ...
        >
          <div className="glass-card p-8 rounded-3xl mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-primary/10 p-6 rounded-2xl">
                <h4 className="text-lg font-bold mb-3 text-accent">التوسع الاستراتيجي</h4>
                <p className="leading-relaxed">وضع خطط مدروسة للدخول إلى قطاعات جديدة مثل الملابس الرجالية والزي الوطني</p>
              </div>

              <div className="bg-primary/10 p-6 rounded-2xl">
                <h4 className="text-lg font-bold mb-3 text-accent">المسؤولية المجتمعية</h4>
                <p className="leading-relaxed">تعزيز مشاركة المؤسسة في المبادرات الاجتماعية والوطنية</p>
              </div>
            </div>

            <p className="text-lg leading-relaxed mb-8">
              تحت قيادته، تعمل المؤسسة على الجمع بين الأصالة التي تأسست عليها منذ 1979م وبين التجديد والابتكار لمواكبة تطلعات السوق السعودي ورؤية المملكة 2030، بهدف ترسيخ الصقر الخليجي كاسم وطني عريق قادر على المنافسة محليًا وخليجيًا.
            </p>
          </div>
          ...
          <div className="glass-card p-8 rounded-3xl mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-accent/10 p-6 rounded-2xl">
                <h4 className="text-lg font-bold mb-3 text-accent">التواجد الإقليمي</h4>
                <p className="leading-relaxed mb-2">• التوسع خارج أسواق الرياض والقرية الشعبية نحو بقية مناطق المملكة</p>
                <p className="leading-relaxed">• وضع خطة للانتشار في الخليج كمؤسسة سعودية تحمل قيمة ومصداقية</p>
              </div>
            ...
            <p className="text-lg leading-relaxed mt-6">
              من خلال هذه الرؤية، يسعى ذياب عايض النوب إلى أن تكون الصقر الخليجي علامة سعودية قوية، متجددة، وذات أثر اقتصادي ومجتمعي، وأن تبقى شريكًا في مسيرة التنمية الوطنية حتى ما بعد عام 2030.
            </p>
          </div>
