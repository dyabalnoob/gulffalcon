...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    // Sample brands
    const brands = [
      { name: "ماركة الأناقة", slug: "marca-elegance", description: "رائدة في الأناقة الرجالية", logoUrl: "/images/brands/marca-elegance.png" },
      { name: "دار الفخامة", slug: "dar-luxury", description: "تصاميم فاخرة ومميزة", logoUrl: "/images/brands/dar-luxury.png" },
      { name: "بيت الأزياء", slug: "bait-fashion", description: "أزياء تقليدية عصرية", logoUrl: "/images/brands/bait-fashion.png" },
      { name: "معرض النخبة", slug: "maerad-elite", description: "للرجل المتميز", logoUrl: "/images/brands/maerad-elite.png" },
      { name: "صالون الرجل", slug: "salon-man", description: "أناقة بلا حدود", logoUrl: "/images/brands/salon-man.png" },
      { name: "متجر الأصالة", slug: "store-authenticity", description: "تراث وعراقة", logoUrl: "/images/brands/store-authenticity.png" },
    ];
    ...
    const products = [
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        brandId: brandIds[0],
        tags: ["ثوب", "تقليدي"]
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        brandId: brandIds[1],
        tags: ["مشلح", "فاخر"]
      },
      {
