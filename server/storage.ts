...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const products = [
      ...
      // فراء شتوية فاخرة
      {
        nameAr: "فروة شتوية فاخرة - أسود ذهبي إمبراطوري",
        nameEn: "Luxury Winter Fur - Imperial Black Gold",
        slug: "luxury-winter-fur-imperial-black-gold",
        descriptionAr: "فروة شتوية فاخرة باللون الأسود مع تطريز ذهبي إمبراطوري، صناعة يدوية متقنة من أجود الخامات الطبيعية، تصميم حصري يليق بالملوك والأمراء",
        descriptionEn: "Luxury winter fur in black with imperial golden embroidery, exquisite handcrafted from finest natural materials, exclusive design befitting kings and princes",
        luxuryTaglineAr: "دفء الشتاء الملكي يلتقي بفخامة الأسود الذهبي في تحفة لا تُقدر بثمن",
        luxuryTaglineEn: "Royal winter warmth meets black gold luxury in a priceless masterpiece",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-1_1757835692310.jpg",
        images: [],
        category: "furs",
        subcategory: "imperial",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "أسود", "ذهبي", "تفصيل", "إمبراطوري"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "أسود إمبراطوري", nameEn: "Imperial Black", hex: "#000000" },
          { nameAr: "ذهبي ملكي", nameEn: "Royal Gold", hex: "#FFD700" },
          { nameAr: "أسود لؤلؤي", nameEn: "Pearl Black", hex: "#2F2F2F" }
        ],
        materialAr: "فراء طبيعي فاخر مع تطريز ذهبي يدوي",
        materialEn: "Premium natural fur with hand-stitched golden embroidery",
        price: null,
        salePrice: null,
        stock: 15,
        featured: true,
      ...
      {
        nameAr: "فروة شتوية فاخرة - كحلي بني مخطط",
        nameEn: "Luxury Winter Fur - Navy Brown Striped",
        slug: "luxury-winter-fur-navy-brown-striped",
        descriptionAr: "فروة شتوية فاخرة بتصميم مخطط كحلي وبني مع تفاصيل ذهبية أنيقة، قطعة فريدة تجمع بين الدفء والأناقة، مثالية لفصل الشتاء",
        descriptionEn: "Luxury winter fur in navy brown striped design with elegant golden details, unique piece combining warmth with elegance, perfect for winter season",
        luxuryTaglineAr: "خطوط الأناقة الكحلية البنية تتراقص مع ذهب الشتاء في سيمفونية دافئة",
        luxuryTaglineEn: "Navy brown elegance stripes dancing with winter gold in a warm symphony",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-2_1757835692310.jpg",
        images: [],
        category: "furs",
        subcategory: "striped",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "كحلي", "بني", "مخطط", "تفصيل"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "كحلي بني", nameEn: "Navy Brown", hex: "#1E1E3F" },
          { nameAr: "بني كحلي", nameEn: "Brown Navy", hex: "#8B4513" },
          { nameAr: "ذهبي أنيق", nameEn: "Elegant Gold", hex: "#DAA520" }
        ],
        materialAr: "فراء طبيعي مخطط مع تفاصيل ذهبية فاخرة",
        materialEn: "Natural striped fur with luxurious golden details",
        price: null,
        salePrice: null,
        stock: 12,
        featured: true,
      ...
      {
        nameAr: "فروة شتوية فاخرة - أسود تراثي مطرز",
        nameEn: "Luxury Winter Fur - Heritage Black Embroidered",
        slug: "luxury-winter-fur-heritage-black-embroidered",
        descriptionAr: "فروة شتوية فاخرة باللون الأسود مع تطريز تراثي أصيل، قطعة تحمل عبق التراث العربي العريق مع دفء استثنائي، صناعة يدوية متقنة",
        descriptionEn: "Luxury winter fur in black with authentic heritage embroidery, piece carrying the essence of glorious Arab heritage with exceptional warmth, exquisite handcrafted",
        luxuryTaglineAr: "سواد التراث الأصيل يحتضن دفء الأجداد في قطعة تاريخية خالدة",
        luxuryTaglineEn: "Authentic heritage black embracing ancestral warmth in an eternal historical piece",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-3_1757835692311.jpg",
        images: [],
        category: "furs",
        subcategory: "heritage",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "أسود", "تراثي", "مطرز", "تفصيل"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "أسود تراثي", nameEn: "Heritage Black", hex: "#000000" },
          { nameAr: "بني تراثي", nameEn: "Heritage Brown", hex: "#8B4513" },
          { nameAr: "ذهبي أصيل", nameEn: "Authentic Gold", hex: "#B8860B" }
        ],
        materialAr: "فراء طبيعي أسود مع تطريز تراثي أصيل",
        materialEn: "Natural black fur with authentic heritage embroidery",
        price: null,
        salePrice: null,
        stock: 18,
        featured: true,
      ...
      {
        nameAr: "فروة شتوية فاخرة - بني كلاسيكي مميز",
        nameEn: "Luxury Winter Fur - Distinguished Classic Brown",
        slug: "luxury-winter-fur-distinguished-classic-brown",
        descriptionAr: "فروة شتوية فاخرة باللون البني الكلاسيكي مع تطريز مميز، تصميم خالد يجمع بين الأناقة والدفء، مثالية للرجل الأنيق والمتميز",
        descriptionEn: "Luxury winter fur in classic brown with distinguished embroidery, timeless design combining elegance with warmth, perfect for the elegant and distinguished man",
        luxuryTaglineAr: "بني الكلاسيكية الخالدة يتوهج بدفء الشتاء في تحفة من الأناقة المتميزة",
        luxuryTaglineEn: "Timeless classic brown glowing with winter warmth in a masterpiece of distinguished elegance",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-4_1757835692311.jpg",
        images: [],
        category: "furs",
        subcategory: "classic",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "بني", "كلاسيكي", "مميز", "تفصيل"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "بني كلاسيكي", nameEn: "Classic Brown", hex: "#8B4513" },
          { nameAr: "بني فاتح", nameEn: "Light Brown", hex: "#D2B48C" },
          { nameAr: "ذهبي كلاسيكي", nameEn: "Classic Gold", hex: "#DAA520" }
        ],
        materialAr: "فراء طبيعي بني مع تطريز كلاسيكي أنيق",
        materialEn: "Natural brown fur with elegant classic embroidery",
        price: null,
        salePrice: null,
        stock: 14,
        featured: true,
      ...
      {
        nameAr: "فروة شتوية فاخرة - أسود خطوط ذهبية",
        nameEn: "Luxury Winter Fur - Black Golden Stripes",
        slug: "luxury-winter-fur-black-golden-stripes",
        descriptionAr: "فروة شتوية فاخرة باللون الأسود مع خطوط ذهبية أنيقة، تصميم عصري مذهل يجمع بين الفخامة والحداثة، قطعة استثنائية لفصل الشتاء",
        descriptionEn: "Luxury winter fur in black with elegant golden stripes, stunning modern design combining luxury with modernity, exceptional piece for winter season",
        luxuryTaglineAr: "خطوط الذهب تتراقص على سواد الليل في أوبرا شتوية من الفخامة المطلقة",
        luxuryTaglineEn: "Golden stripes dancing on midnight black in a winter opera of absolute luxury",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-5_1757835692312.jpg",
        images: [],
        category: "furs",
        subcategory: "striped-luxury",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "أسود", "ذهبي", "خطوط", "تفصيل"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "أسود ذهبي", nameEn: "Black Gold", hex: "#000000" },
          { nameAr: "ذهبي لامع", nameEn: "Shiny Gold", hex: "#FFD700" },
          { nameAr: "أسود لؤلؤي", nameEn: "Pearl Black", hex: "#2F2F2F" }
        ],
        materialAr: "فراء طبيعي أسود مع خطوط ذهبية مطرزة",
        materialEn: "Natural black fur with embroidered golden stripes",
        price: null,
        salePrice: null,
        stock: 16,
        featured: true,
      ...
      {
        nameAr: "فروة شتوية فاخرة - أسود بني مطرز تراثي",
        nameEn: "Luxury Winter Fur - Black Brown Heritage Embroidered",
        slug: "luxury-winter-fur-black-brown-heritage-embroidered",
        descriptionAr: "فروة شتوية فاخرة بتصميم أسود وبني مع تطريز تراثي فاخر، قطعة تجمع بين الأصالة والدفء، تصميم حصري يحمل روح التراث العربي الأصيل",
        descriptionEn: "Luxury winter fur in black and brown design with luxurious heritage embroidery, piece combining authenticity with warmth, exclusive design carrying authentic Arab heritage spirit",
        luxuryTaglineAr: "تراث الأجداد الأسود البني يحتضن دفء الشتاء في لوحة فنية خالدة",
        luxuryTaglineEn: "Ancestral black brown heritage embracing winter warmth in an eternal artistic canvas",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-6_1757835692312.jpg",
        images: [],
        category: "furs",
        subcategory: "heritage-luxury",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "أسود", "بني", "تراثي", "تفصيل"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "أسود بني", nameEn: "Black Brown", hex: "#2F1B14" },
          { nameAr: "بني تراثي", nameEn: "Heritage Brown", hex: "#8B4513" },
          { nameAr: "ذهبي تراثي", nameEn: "Heritage Gold", hex: "#B8860B" }
        ],
        materialAr: "فراء طبيعي أسود بني مع تطريز تراثي فاخر",
        materialEn: "Natural black brown fur with luxurious heritage embroidery",
        price: null,
        salePrice: null,
        stock: 11,
        featured: true,
      ...
      {
        nameAr: "فروة الصقر الخليجي الملكية - إصدار محدود شتاء 2025",
        nameEn: "Gulf Falcon Royal Fur - Limited Edition Winter 2025",
        slug: "gulf-falcon-royal-fur-limited-edition-winter-2025",
        descriptionAr: "فروة الصقر الخليجي الملكية - إصدار محدود شتاء 2025، قطعة استثنائية حصرية تحمل شعار المؤسسة الفاخر، تصميم ملكي فريد للشخصيات المرموقة",
        descriptionEn: "Gulf Falcon Royal Fur - Limited Edition Winter 2025, exceptional exclusive piece bearing the corporation's luxury logo, unique royal design for prestigious personalities",
        luxuryTaglineAr: "إصدار ملكي محدود من فراء الصقر الخليجي يحمل روح الشتاء الإمبراطوري في تحفة لا تُقدر بثمن",
        luxuryTaglineEn: "Royal limited edition of Gulf Falcon fur carrying imperial winter spirit in a priceless masterpiece",
        mainImage: "/images/products/الصقر-الخليجي-فروة-رجالي-فاخرة-2025-7_1757835692313.jpg",
        images: [],
        category: "furs",
        subcategory: "royal-limited",
        brandId: brandIds[0],
        tags: ["فروة", "شتوية", "فاخرة", "الصقر الخليجي", "ملكية", "محدود", "تفصيل"],
        sizes: ["S", "M", "L", "XL", "XXL", "3XL"],
        colors: [
          { nameAr: "رمادي ملكي", nameEn: "Royal Gray", hex: "#708090" },
          { nameAr: "ذهبي ملكي", nameEn: "Royal Gold", hex: "#FFD700" },
          { nameAr: "الصقر الخليجي", nameEn: "Gulf Falcon", hex: "#B8860B" }
        ],
        materialAr: "فراء ملكي حصري خاص بمؤسسة الصقر الخليجي",
        materialEn: "Exclusive royal fur special to Gulf Falcon Corporation",
        price: null,
        salePrice: null,
        stock: 8,
        featured: true,
