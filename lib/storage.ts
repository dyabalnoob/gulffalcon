...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const products: Product[] = [
      // Prayer Beads Collection (سبح)
      {
        ...
        sizes: [],
        colors: [],
        materialAr: "كهرمان طبيعي",
        materialEn: "Natural Amber",
        featured: true,
        isNew: false,
      ...
      },
      {
        ...
        luxuryTaglineAr: null,
        luxuryTaglineEn: null,
        price: "180.00",
        salePrice: null,
      ...
      },
      {
        ...
        sizes: [],
        colors: [],
        materialAr: "خشب طبيعي",
        materialEn: "Natural Wood",
        featured: false,
        isNew: false,
        isCustomizable: false,
        stock: 25,
      ...
      // Cloaks Collection (مشالح)
      {
        ...
        sizes: [],
        colors: [],
        materialAr: "أقمشة فاخرة",
        materialEn: "Luxury Fabrics",
        featured: true,
        isNew: true,
        isCustomizable: false,
        stock: 8,
      ...
      // Fur Coats Collection (فراء)
      {
        ...
        sizes: [],
        colors: [],
        materialAr: "فرو طبيعي",
        materialEn: "Natural Fur",
        featured: true,
        isNew: true,
        isCustomizable: false,
        stock: 5,
      ...
      },
      {
        ...
        sizes: [],
        colors: [],
        materialAr: "خشب ومعدن",
        materialEn: "Wood and Metal",
        featured: false,
        isNew: false,
        isCustomizable: false,
        stock: 8,
  ...
  async createBrand(brandData: InsertBrand): Promise<Brand> {
    const brand: Brand = {
      id: this.generateId(),
      ...brandData,
      descriptionAr: brandData.descriptionAr ?? null,
      descriptionEn: brandData.descriptionEn ?? null,
  ...
  async createProduct(productData: InsertProduct): Promise<Product> {
    const product: Product = {
      ...
      luxuryTaglineAr: productData.luxuryTaglineAr ?? null,
      luxuryTaglineEn: productData.luxuryTaglineEn ?? null,
      ...
      colors: (productData.colors ?? []) as { nameAr: string; nameEn: string; hex: string }[],
      materialAr: productData.materialAr ?? null,
      materialEn: productData.materialEn ?? null,
